...
@prove
def prove(Eq):
    from Lemma import Finset, Algebra, Tensor, Bool, Set, Nat
    ...
    * _, b_i = Eq[-1].rhs.args[1].expr.args
    ...
    Eq << Eq[-1].this.expr.apply(Bool.Cond.Any.given.Any_And, simplify=None)
    ...
    Eq << Finset.All_In.of.All_In.swapn.MatProd.apply(Eq.swap.T, n, b)
