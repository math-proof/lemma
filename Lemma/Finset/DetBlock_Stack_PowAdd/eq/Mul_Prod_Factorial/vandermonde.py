...
def prove(Eq):
    ...
    Eq << Finset.DetBlock_Stack_Pow.eq.Mul_Prod_Factorial.vandermonde.apply(Det(BlockMatrix([Stack[j:n + 1](r ** j), Stack[j:n + 1, i:n](j ** i)])))
    ...
    Eq << Eq[-1].this.lhs.apply(Finset.Det.Block.eq.Mul)
