...
def prove(Eq):
    ...
    Eq << RisingFactorial(k, i).this.apply(Finset.RisingFactorial.eq.Mul.shift)

    Eq << RisingFactorial(k + 1, i).this.apply(Finset.RisingFactorial.eq.Mul.pop)
    ...
    Eq << Eq[0].this.lhs.expr.base.apply(Finset.RisingFactorial.eq.Mul.pop)
