...
def prove(Eq):
    ...
    Eq << Real.Integral.eq.Mul.Limit.Maxima.Darboux.of.Lt.apply(Eq[0], Eq[1].lhs)

    Eq << Real.Integral.eq.Mul.Limit.Minima.Darboux.of.Lt.apply(Eq[0], Eq[1].lhs)
    ...
    Eq << Real.EqDarboux.of.Lt.Eq_Limit.apply(Eq[0], Eq[-1])
