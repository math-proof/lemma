...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.rhs.apply(Real.Integral.eq.Mul.Limit.Lebesgue.of.Ge_0, Eq[-3].find(Integral)), Eq[-1].this.rhs.apply(Real.Integral.eq.Mul.Limit.Lebesgue.of.Ge_0, Eq[-4].find(Integral))
