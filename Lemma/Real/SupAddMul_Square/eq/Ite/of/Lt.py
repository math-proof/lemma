...
def prove(Eq):
    ...
    Eq <<= Eq[-3].this.apply(Bool.Imp_Imp.Is.ImpAnd), Eq[-2].this.apply(Bool.Imp_Imp.Is.ImpAnd), Eq[-1].this.lhs.apply(Real.Sup_Add_Mul_Square.eq.IteIn.of.Lt_0.Lt, a * x ** 2 + b * x + c, x)
    ...
    Eq << Eq[-1].this.rhs.apply(Real.Sup.eq.MaxAddS_Mul_Square.of.Gt_0.Lt, a * x ** 2 + b * x + c, x)

    Eq << Real.Sup.eq.MaxAddS_Mul.of.Lt.apply(Eq[0], b * x + c, x)
