...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(Real.Eq_0.Limit.of.In_Icc.geometric_series.positive, n)
    ...
    Eq << Eq[-1].this.lhs.apply(Real.Eq_0.Limit.of.In_Icc.geometric_series.negative, n)
