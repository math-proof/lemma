...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.expr.apply(Bool.UFn.of.UFn.Eq, reverse=True), \
    Eq[-1].this.expr.apply(Bool.UFn.of.UFn.Eq, reverse=True)
    ...
    Eq <<= Real.LeLim.of.Le.apply(Eq[-2], (n, oo)), Real.LeLim.of.Le.apply(Eq[-1], (n, oo))
