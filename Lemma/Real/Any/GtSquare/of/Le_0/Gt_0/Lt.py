...
@prove
def prove(Eq):
    from Lemma import Set, Real, Int
    ...
    Eq << Eq[1].this.apply(Int.GtAdd.Is.Gt_Sub).reversed

    Eq << Real.Any.GtSquare.of.Ge_0.Lt.Lt.apply(Eq[-2], Eq[-1], Eq[2])

    Eq << Set.Subset.Icc.of.Le_0.upper.apply(Eq[0], M, left_open=True, right_open=True)
