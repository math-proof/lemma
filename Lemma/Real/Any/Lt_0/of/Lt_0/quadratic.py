...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.rhs.apply(Real.Any.Lt_0.of.Lt_0.Add.ge.Zero, x=x), Eq[-1].this.rhs.apply(Rat.Lt_0.of.Lt_0.Add.lt.Zero, x=x)

    Eq << Eq[-1].this.rhs.apply(Bool.Any.of.Cond, wrt=x)
