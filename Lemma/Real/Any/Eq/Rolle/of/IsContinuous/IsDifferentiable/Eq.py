...
def apply(is_continuous, is_differentiable, equal):
    from Lemma.Real.Any.Eq.Rolle.of.Lt.IsContinuous.IsDifferentiable.Eq import of_continuous, of_differentiable
...
def prove(Eq):
    ...
    Eq << Real.Any.Eq.Rolle.of.Lt.IsContinuous.IsDifferentiable.Eq.apply(Eq[-1], Eq[0], Eq[1], Eq[2])
