...
def prove(Eq):
    ...
    Eq << Eq[2].this.expr.apply(Set.Eq.of.In.definition)

    Eq.All_And = Eq[-1].this.expr.apply(Real.And.Eq_Grad.of.Eq_Grad)
    ...
    Eq <<= Bool.All_And.of.All.Cond.apply(Eq[-1], Eq[-3]), Bool.All_And.of.All.Cond.apply(Eq[-1], Eq[-2])

    Eq <<= Eq[-2].this.expr.apply(Bool.UFn.of.UFn.Eq, reverse=True, simplify=None), Eq[-1].this.expr.apply(Bool.UFn.of.UFn.Eq, reverse=True, simplify=None)
