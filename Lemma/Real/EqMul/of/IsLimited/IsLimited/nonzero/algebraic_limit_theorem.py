...
def prove(Eq):
    ...
    Eq.Limit_A_definition = Real.Any.All.of.IsLimited.limit_definition.symbol_subs.apply(Eq[0], ε_0, δ_0, var='A')
    ...
    Eq << Bool.Any_UFn.of.Any_UFnUFn.apply(Eq[-1], Min(δ_0, δ_1, δ_2), delta)
