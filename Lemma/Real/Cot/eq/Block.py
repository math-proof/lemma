...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(Real.Cot.eq.Ite)

    Eq << Eq[-1].this.find(Cot[Piecewise]).apply(Real.Cot.eq.Ite)

    Eq << Eq[-1].this.find(Cot[Piecewise]).apply(Real.Cot.eq.Ite, simplify=0)
