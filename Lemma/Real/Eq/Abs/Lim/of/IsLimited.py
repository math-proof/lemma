...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(Real.Eq_0.Lim.Abs.of.Eq_0)
    ...
    Eq << Eq[-2].this.lhs.apply(Real.Eq.Lim.Abs.of.IsNegative)

    Eq << Eq[-1].this.lhs.apply(Real.Eq.Lim.Abs.of.IsPositive)
