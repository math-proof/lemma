...
def prove(Eq):
    ...
    Eq << Eq[2].this.lhs.apply(Real.Sup.eq.Add)
    ...
    Eq <<= Eq[-2].this.find(Sup).apply(Real.Sup.limits.subst.offset, Eq[3].lhs * -b /2), Eq[-1].this.find(Sup).apply(Real.Sup.limits.subst.offset, Eq[3].lhs * -b /2)
    ...
    Eq <<= Eq[-2].this.rhs.apply(Real.Sup_Square.eq.Square.of.Lt_0.Ge_0.Lt), \
        Eq[-2].this.rhs.apply(Int.Max.eq.Square.of.Lt_0.Ge_0.Lt),\
        Eq[-1].this.rhs.apply(Real.Sup_Square.eq.Square.of.Lt_0.Le_0.Lt),\
        Eq[-1].this.rhs.apply(Int.Max.eq.Square.of.Lt_0.Le_0.Lt)
