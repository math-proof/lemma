...
@prove
def prove(Eq):
    from Lemma import Nat, Real, Rat
    ...
    Eq << Real.GeSqrt_0.apply(Eq[0])

    Eq.is_positive = Nat.GtAdd.of.Gt.Ge.apply(Eq[-2], Eq[-1])

    Eq << Nat.Gt_0.of.Gt.apply(Eq[1])

    Eq << Rat.GtDiv.of.Gt_0.Gt.apply(Eq.is_positive, Eq[-1])
