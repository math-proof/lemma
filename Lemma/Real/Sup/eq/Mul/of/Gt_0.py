...
def prove(Eq):
    ...
    Eq << Eq[-1].this.rhs.expr.apply(Nat.GtMul.of.Gt_0.Gt)

    Eq << Eq[-1].this.find(Less).apply(Rat.Lt.given.And.scale.positive, a)
    ...
    Eq <<= Real.LeSup.given.All.Le.apply(Eq[-2]), Real.GeSup.given.All_Any_Gt.apply(Eq[-1], z)
