...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.rhs.apply(Real.Inf_Square.eq.Square.of.Ge_0.Lt), Eq[-2].this.rhs.apply(Nat.EqMin.of.Ge_0.Lt), \
        Eq[-1].this.rhs.apply(Real.Inf_Square.eq.Square.of.Le_0.Lt), Eq[-1].this.rhs.apply(Nat.EqMin.of.Le_0.Lt)
    ...
    Eq <<= Eq[-2].this.lhs.apply(Real.Inf_Square.eq.Zero.of.Gt_0.Le_0), Bool.Imp_AndEq.given.Imp_AndEq.apply(Eq[-1])
