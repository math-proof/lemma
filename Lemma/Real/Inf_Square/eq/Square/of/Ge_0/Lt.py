...
def prove(Eq):
    ...
    Eq <<= Eq[-5].subs(Eq.eq_abs_m), Eq[-4].this.lhs.apply(Nat.Gt_Sub_1.of.Gt, lower=0), Eq[-3].this.rhs.apply(Int.GtAdd.Is.Gt_Sub, lhs=slice(1, None)), Bool.Imp.given.Cond.apply(Eq[-2]), Eq[-1].this.lhs.apply(Nat.Gt_Sub_1.of.Gt, lower=0)
