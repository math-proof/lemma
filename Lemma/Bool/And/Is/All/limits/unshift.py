...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.rhs.apply(Bool.All.given.And.All, cond={a - 2}), Eq[-1].this.lhs.apply(Bool.All.All.of.All, cond={a - 2})

    Eq <<= Eq[-2].this.rhs.apply(Bool.All.given.And.All, cond={a - 1}), Eq[-1].this.lhs.find(All).apply(Bool.All.All.of.All, cond={a - 1})
