...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(Trigonometry.Cos.eq.Ite)

    Eq << Eq[-1].this.find(Cos[Piecewise]).apply(Trigonometry.Cos.eq.Ite)

    Eq << Eq[-1].this.find(Cos[Piecewise]).apply(Trigonometry.Cos.eq.Ite, simplify=0)
