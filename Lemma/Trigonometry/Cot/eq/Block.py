...
def prove(Eq):
    ...
    Eq << Eq[-1].this.lhs.apply(Trigonometry.Cot.eq.Ite)

    Eq << Eq[-1].this.find(Cot[Piecewise]).apply(Trigonometry.Cot.eq.Ite)

    Eq << Eq[-1].this.find(Cot[Piecewise]).apply(Trigonometry.Cot.eq.Ite, simplify=0)
