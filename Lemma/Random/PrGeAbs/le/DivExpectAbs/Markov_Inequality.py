...
def prove(Eq):
    ...
    Eq.ge = Eq[-1].this.rhs.find(Integral).apply(Random.Integral.eq.Pr)
    ...
    Eq << Eq[-1].this.rhs.find(Integral).apply(Random.Integral.eq.Pr)
    ...
    Eq << Eq[-1].this.rhs.apply(Random.Pr.Or.eq.Add)
