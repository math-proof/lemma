...
@prove
def prove(Eq):
    from Lemma import Random, Real, Bool, Rat, Tensor, Finset
    ...
    Eq << Eq[1].this.lhs.find(Pr).apply(Random.Prob.eq.Integral.joint, s[1:k])
    ...
    Eq << Eq[-1].this.rhs.apply(Random.Prob.eq.Integral.joint, s[1:k])
