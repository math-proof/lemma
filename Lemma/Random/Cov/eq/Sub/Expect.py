...
@prove
def prove(Eq):
    from Lemma import Random, Tensor, Nat
    ...
    Eq << Eq[0].this.lhs.apply(Random.Cov.eq.Expect)
    ...
    Eq << Eq[-1].this.find(Expectation[Conditioned[Add]]).apply(Random.Expect_Add.eq.AddExpectS)
