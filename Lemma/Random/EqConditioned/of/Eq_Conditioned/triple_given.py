...
@prove
def prove(Eq):
    from Lemma import Random, Bool, Tensor
    ...
    Eq << Eq[-1].this().expr.lhs.rhs.args[1].apply(Tensor.GetSlice.Get.of.Eq)

    Eq << Random.Eq.of.Eq_Conditioned.single_condition_w.apply(Eq[-1], wrt=Eq[-1].lhs.rhs.args[-1].lhs)
