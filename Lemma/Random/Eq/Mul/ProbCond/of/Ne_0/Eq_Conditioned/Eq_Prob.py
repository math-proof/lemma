...
def prove(Eq):
    ...
    Eq.ne_zero_xy = Random.All_NeProb_0.of.All_Ne0ProbJoint.apply(Eq[0], 0)

    Eq.eq_div = Random.Eq.ProbCond.eq.Div.ProbCond.of.Ne_0.bayes.apply(Eq[0], slice(2, None, -2))

    Eq << Random.All_NeProb_0.of.All_Ne0ProbJoint.apply(Eq.ne_zero_xy)
