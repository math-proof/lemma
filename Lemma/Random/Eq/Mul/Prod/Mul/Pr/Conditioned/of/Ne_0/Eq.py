...
def prove(Eq):
    ...
    Eq << Random.Eq.Mul.Prod.Pr.Conditioned.of.Ne_0.Eq.apply(*Eq[:2])

    Eq << Random.Ne_0.of.Ne_0.joint_slice.apply(Eq[1], [None, j])

    Eq << Random.Eq.Pr.Conditioned.eq.Div.Pr.Conditioned.of.Ne_0.bayes.apply(Eq[-1])
