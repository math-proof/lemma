...
@prove
def prove(Eq):
    from Lemma import Random, Real, Int, Nat, Set
    ...
    Eq.ge = Eq[-1].this.rhs.find(Integral).apply(Random.Integral.eq.Prob)
    ...
    Eq << Eq[-1].this.rhs.find(Integral).apply(Random.Integral.eq.Prob)
    ...
    Eq << Eq[-1].this.rhs.apply(Random.Prob.Or.eq.Add)
