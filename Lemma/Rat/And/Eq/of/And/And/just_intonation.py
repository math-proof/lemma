...
def prove(Eq):
    ...
    Eq.d_1_sharp, Eq.d_2_sharp, Eq.d_4_sharp, Eq.d_5_sharp, Eq.d_6_sharp = Bool.And.given.And.Eq.continued.apply(Eq.et_d5, Number(2) ** 11 / 3 ** 7)

    Eq.d_1, Eq.d_2, Eq.d_3, Eq.d_4, Eq.d_5, Eq.d_6, Eq.d_7 = Bool.And.given.And.Eq.continued.apply(Eq.et_d7, Number(3) ** 5 / 2 ** 8)

    # eight degree of musical tones: h_*, huit
    Eq.h_7, Eq.h_1, Eq.h_1_sharp, Eq.h_2, Eq.h_2_sharp, Eq.h_3 = Bool.And.Eq.of.And.just_intonation.apply(Eq.et_h, S.One / 2)
    ...
    Eq.c_4_sharp, Eq.c_5, Eq.c_5_sharp, Eq.c_6, Eq.c_6_sharp, Eq.c_7, Eq.c_1, Eq.c_1_sharp, Eq.c_2, Eq.c_2_sharp, Eq.c_3 = Bool.And.Eq.of.And.just_intonation.apply(Eq[-1], Number(2) / 3)
