...
def prove(Eq):
    ...
    Eq << Eq[-1].this.find(And).apply(Nat.LeSquare.of.Ge_0.Le)

    Eq << Eq[-1].this.args[1].apply(Nat.Le.of.Le.relax, Eq[2].rhs)
    ...
    Eq << Eq[-1].this.find(And).apply(Int.LeSquare.of.Le_0.Ge)
