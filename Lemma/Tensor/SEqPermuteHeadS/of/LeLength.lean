...
open Nat Bool List Tensor Vector Fin
  ...
  ·
    ...
    ·
      ...
      ·
        ...
        have h_q := q.isLt
        have h_r := r.isLt
        simp [Drop.eq.Nil.of.LeLength h] at h_r
        simp [GetFlatten.eq.Get.of.Eq_AddMul h_qr]
        simp [Drop.eq.Nil.of.LeLength h] at h_t
        simp [EqTake.of.LeLength h] at h_t
        ...
        simp [Drop.eq.Nil.of.LeLength h] at h_q_div
        ...
        ·
          ...
          rw [Rotate.eq.AppendDrop__Take]
      ·
        repeat rw [Drop.eq.Nil.of.LeLength h]
        simp
        rw [EqTake.of.LeLength h]
