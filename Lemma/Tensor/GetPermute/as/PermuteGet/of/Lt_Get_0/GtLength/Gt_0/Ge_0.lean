import Lemma.Tensor.GetPermute.as.PermuteGet.of.Lt_Get_0.GtLength.Gt_0
...
-- proof
  have := GetPermute.as.PermuteGet.of.Lt_Get_0.GtLength.Gt_0 (i := i) (k := k) (by grind) (by grind) (by grind) X d.toNat
  grind
