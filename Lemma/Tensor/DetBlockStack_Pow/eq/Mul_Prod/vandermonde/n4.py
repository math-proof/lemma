...
def prove(Eq):
    ...
    Eq << Eq.eq_block.rhs.args[3].expr.this.find(Pow).apply(Real.Pow_Add.eq.MulPowS.of.Gt_0, simplify=None)
    ...
    Eq << Eq[-1].this.rhs.args[4].args[1].find(Stack).apply(Tensor.Stack.eq.Tensor)
