...
from Lemma.Tensor.DotT.eq.RotaryMatrixSub.of.Eq_Stack_Mul.Ge import rotary_matrix, extract
@apply
...
def prove(Eq):
    ...
    Eq << Tensor.DotT.eq.RotaryMatrixSub.of.Eq_Stack_Mul.Ge.apply(Eq[0], t)
