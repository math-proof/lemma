  ...
  | succ i ih =>
    ...
    | s₀ :: s =>
      ...
      .
        ...
        rw [GetSum.eq.Cast_SumGet.of.GtGet_0.Gt_0.GtLength.fin (by simp; omega) (by simp) (by simpa)]
        apply SEqCast.of.SEq.Eq
        .
          ...
          simp
        .
          rw [GetSum.eq.Cast_SumGet.of.GtGet_0.Gt_0.GtLength.fin (by simpa) (by simp) (by simpa)]
          apply SEq_Cast.of.SEq.Eq (by simp)
          rw [show i + 1 + d - 1 = i + d by simp]
          have := GetPermute.as.PermuteGet.of.GtGet_0.LtAdd_1Length (i := i) (by simpa) h_t X d
