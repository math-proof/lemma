...
def apply(eq, Q_def, V_def, n=None):
    ...
    return Equal(Derivative[π](V_st_var._subs(s[t].bvar, s[0].bvar)),
                 Sum[s[1:t + 1].bvar, t:n](γ ** t * (Product[t:t](Pr(s[t + 1] | s[t])) * Sum[a[t].bvar](Derivative[π](Pr[a:π](a[t] | s[t])) * Q_st_var))) + \
                 γ ** n * Sum[s[1:n + 1].bvar](Product[t:n](Pr(s[t + 1] | s[t])) * Derivative[π](V_st_var._subs(s[t].bvar, s[n].bvar))))
