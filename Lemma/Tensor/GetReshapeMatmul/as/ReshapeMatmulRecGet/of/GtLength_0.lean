import Lemma.Tensor.GetReshapeMatmul.as.ReshapeMatmulRecGet.of.GtLengthS
...
-- proof
  ...
  have := GetReshapeMatmul.as.ReshapeMatmulRecGet.of.GtLengthS.fin (by grind) X Y i (s' := [])
  simp at this
  apply this.trans
