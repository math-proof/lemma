    ...
    ·
      ...
      ·
        ...
        ·
          ...
          simp [DropRotate.eq.Take.of.GeLength (s := s) (n := 1) (by omega)]
          ...
          conv_rhs at h_q' =>
            simp [s', s₀]
          rw [DropRotate.eq.Take.of.GeLength (by omega)] at h_q'
          have := h_q'
          rw [ProdTake_1.eq.Get_0.of.GtLength_0 (by omega)] at h_q'
          have h_r' := r'.isLt
          conv_rhs at h_r' =>
            simp [s', s₀]
          rw [TakeRotate.eq.Drop.of.GeLength (by omega)] at h_r'
          simp at h_r'
          ...
          ·
            ...
            ·
              ...
              ·
                ...
                simp [h_qr]
                simp [s', s₀] at h_q'r'
                rw [TakeRotate.eq.Drop.of.GeLength (by omega)] at h_q'r'
                simp at h_q'r'
                simp_all
              ·
                simp [EqMod.of.Lt h]
