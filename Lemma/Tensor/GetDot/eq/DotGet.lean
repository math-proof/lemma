...
-- proof
  ...
  ·
    ...
    erw [EqGetUnsqueeze_0.fin]
    apply Eq.of.SEq
    apply GetResize.as.ResizeGet.of.GtGet_0.GtVal_0 (d := ⟨1, by grind⟩) (by grind) (by grind)
  ·
    erw [GetCast.eq.Cast_Get.of.Eq.GtLength_0.fin (s' := [n, 1, k ⊔ n']) (i := ⟨i, by grind⟩) (by grind) (by grind)]
    ...
    simp
    erw [EqGetUnsqueeze_0.nat.fin (z := ⟨i % 1, by grind⟩) ((Y.resize 0 (k ⊔ n')).unsqueeze 0)]
    erw [EqGetUnsqueeze_0.fin]
