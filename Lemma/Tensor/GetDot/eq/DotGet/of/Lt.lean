...
-- proof
  ...
  ·
    ...
    erw [Tensor.GetUnsqueeze.eq.Cast_UnsqueezeGet.of.GtGet_0.Gt_0.GtLength_0.fin (by grind) (by grind) (by grind)]
    conv_rhs => erw [Tensor.GetUnsqueeze.eq.Cast_UnsqueezeGet.of.GtGet_0.Gt_0.GtLength_0.fin (by grind) (by grind) (by grind)]
    apply SEq.of.Eq ∘ EqCastS.of.SEq.Eq (by simp)
    simp
    apply Tensor.SEqUnsqueezeS.of.SEq
    erw [Tensor.EqGetUnsqueeze_0.fin]
    erw [Tensor.GetResize.eq.Cast_ResizeGet.of.GtGet_0.GtVal_0.fin (by grind) (by simp; grind)]
    simp
    rfl
  ·
    simp
