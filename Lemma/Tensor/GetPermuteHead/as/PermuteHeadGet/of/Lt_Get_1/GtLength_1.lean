              ...
              ·
                ...
                ·
                  ...
                  ·
                    ...
                    simp [DropEraseIdx.eq.Drop.of.Le (show d ≥ 1 by omega)] at h_rₕ_mod h_r h_q_div h_r_mod
                    ...
                    ·
                      ...
                      rw [List.ProdEraseIdx.eq.Mul_ProdDrop_2.of.GtLength_0 (by omega)] at h_t
                      if h_d : d = 1 then
                        subst h_d
                        simp
                        have h_q := LtVal q
                        ...
                        simp [h_rₐ] at ⊢ h_qₕ_div h_rₕ_mod
