...
-- proof
  ...
  ·
    ...
    erw [GetCast.eq.Cast_Get.of.Eq.GtLength_0.fin (s' := (s.insertIdx d 1).set 0 n) (i := ⟨i, by simpa [h_InsertIdx, EqAddMulDiv]⟩) (by grind) (by simp [h_InsertIdx, EqAddMulDiv])]
    ...
    ·
      ...
      erw [GetCast.eq.Cast_Get.of.Eq.GtLength_0.fin (s' := s.set 0 n) (i := ⟨i, by grind⟩) (by grind)]
      simp
      if h_lt : i < n / s[0] * s[0] then
        rw [GetAppend.eq.Get.of.Lt.fin (by simpa [h_InsertIdx])]
        erw [GetCast.eq.Cast_Get.of.Eq.GtLength_0.fin (s' := n / (s.insertIdx d 1)[0]'(by grind) * (s.insertIdx d 1)[0]'(by grind) :: (s.insertIdx d 1).tail) (i := ⟨i, by grind⟩) (by grind) (by simp [h_InsertIdx])]
        erw [UnsqueezeCast.eq.Cast_Unsqueeze.of.Eq]
        ·
          ...
          ·
            ...
            erw [GetCast.eq.Cast_Get.of.Eq.GtLength_0.fin (s' := (n / s[0] * s[0] :: s.tail)) (i := ⟨i, by grind⟩) (by grind)]
            ...
            ·
              ...
              ·
                ...
                erw [UnsqueezeCast.eq.Cast_Unsqueeze.of.Eq (by rw [Set_0.eq.Cons_Tail.of.GtLength_0 (by grind)]; grind)]
                apply SEqCastS.of.SEq.Eq.Eq (by simp [h_InsertIdx]) (by rw [Set_0.eq.Cons_Tail.of.GtLength_0 (by grind)]; grind) (by rfl)
                grind
              ·
                grind
              ·
                rw [Set_0.eq.Cons_Tail.of.GtLength_0 (h := by grind)]
                grind
            ·
              rw [Set_0.eq.Cons_Tail.of.GtLength_0 (h := by grind)]
              grind
        ...
        ·
          rw [EqAddMulDiv, Set_0.eq.Cons_Tail.of.GtLength_0 (h := by grind)]
      else
