...
-- proof
  ...
  have := GetMatmul.as.MatmulCastS_Get.of.Eq.Length.GtLength_0 (by grind) (by grind) (by grind) X'' Y'' i
  ...
  apply MatmulResizeS.as.Matmul.of.Length.GtLength_0 h h_length
