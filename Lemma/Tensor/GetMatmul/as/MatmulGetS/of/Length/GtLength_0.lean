...
import Lemma.Tensor.GetMatmul.as.MatmulCastS_Get.of.Length.GtLength_0
...
-- proof
  ...
  have h_matmul_get := GetMatmul.as.MatmulCastS_Get.of.Length.GtLength_0 h_s h_len X Y ⟨i, by grind⟩
