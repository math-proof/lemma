...
def prove(Eq):
    ...
    Eq << apply(
        ...
        Equal(z, BlockMatrix(
            ...
            V_quote[l - 1:] * Stack[i:n - l + 1](1 + C_quote[i + l - 1] @ C_quote[i:i + l].T) + Stack[i:n - l + 1](A[i + l - 1, i:i + l])) - Stack[i:n](Ones(l) * logsumexp(A[i, relu(i + 1 - l):i + 1] + V_quote[i, :Min(i + 1, l)] * (1 + C_quote[i] @ C_quote[relu(i - l + 1):i + 1].T)))))
