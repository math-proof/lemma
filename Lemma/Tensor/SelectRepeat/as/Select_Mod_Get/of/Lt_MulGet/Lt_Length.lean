...
import Lemma.Tensor.Select_0.as.Get.of.GtLength_0.Lt_Get_0
...
-- proof
  ...
  | zero =>
    have h := Select_0.as.Get.of.GtLength_0.Lt_Get_0 (by simpa) (by simpa) (X.repeat n ⟨0, h_s⟩)
    apply SEq.of.SEq.SEq h
    have h := Select_0.as.Get.of.GtLength_0.Lt_Get_0 (by simpa) (by simp [LtMod.of.Lt_Mul h_i]) X (i := i % s[0])
    apply SEq.of.SEq.SEq h
