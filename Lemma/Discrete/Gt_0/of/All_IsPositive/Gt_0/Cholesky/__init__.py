...
@prove
def prove(Eq):
    from Lemma import Discrete, Algebra, Set, Bool, Tensor, Int, Int
    ...
    Eq << Set.EqRe.of.IsNotZero.square_completing.apply(Eq[-1], Add(*[arg for arg in Eq[-2].lhs.args if arg._has(ξ[k])]), ξ[k], simplify=None)
