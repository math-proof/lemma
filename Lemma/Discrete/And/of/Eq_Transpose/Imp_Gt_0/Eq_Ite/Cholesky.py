...
def apply(eq, infer, eq_piece):
    from Lemma.Discrete.All.And.of.Eq_Transpose.Imp_Gt_0.Eq_Ite.Cholesky import extract
...
def prove(Eq):
    ...
    Eq << Discrete.All.And.of.Eq_Transpose.Imp_Gt_0.Eq_Ite.Cholesky.apply(*Eq[:3], t)
