...
def prove(Eq):
    ...
    Eq << Eq[-1].this.expr.apply(Logic.Bool.eq.One.of.Cond, split=False)

    Eq << Logic.BoolNot.eq.Zero.of.Cond.apply(Eq[1])

    Eq << Eq[-2].this.expr.apply(Logic.Eq.of.Eq.Eq, Eq[-1])
