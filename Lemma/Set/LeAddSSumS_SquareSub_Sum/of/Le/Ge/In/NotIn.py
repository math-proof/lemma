...
def prove(Eq):
    ...
    Eq.Any_And = Bool.Any_And.of.Any.Any.apply(Eq[-3], Eq[-1], simplify=None)
    ...
    Eq << Bool.Any_And.of.Any.Any.apply(Eq[-1], Eq[-4], simplify=None)
    Eq << Bool.Any_And.of.Any.Any.apply(Eq.Any_And, Eq[-1], simplify=None)
