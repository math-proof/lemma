...
def prove(Eq):
    ...
    Eq <<= Eq[-2].this.find(GreaterEqual).apply(Nat.And.Ge.of.Ge_Max), Eq[-1].this.find(GreaterEqual).apply(Algebra.Ge_Max.given.And.Ge)
    ...
    Eq <<= Eq[-2].this.find(Element).apply(Set.In_Ico.given.Ge.Le_Sub_1), Eq[-1].this.find(Element).apply(Set.Ge.Le_Sub_1.of.In_Ico)
