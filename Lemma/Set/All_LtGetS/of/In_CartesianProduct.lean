...
import Lemma.List.GetCartesianProduct.lt.Get.of.GtLength.GtLengthCartesianProduct
open Set List
...
-- proof
  ...
  simp_all [GetCartesianProduct.lt.Get.of.GtLength.GtLengthCartesianProduct h_j h_s]
