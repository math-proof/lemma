...
def prove(Eq):
    ...
    Eq << Eq[-1].this.expr.args[:2].apply(Bool.UFn.of.UFn.Eq, simplify=None)

    Eq << Eq[-1].this.expr.args[1].apply(Set.EqSum.of.In, Eq[-1].expr.args[0].lhs.args[3])

    Eq << Eq[-1].this.expr.apply(Bool.UFn.of.UFn.Eq, simplify=None)
    ...
    Eq << Eq[-1].this.expr.args[3:5].apply(Bool.UFn.of.UFn.Eq, simplify=None)
