...
def prove(Eq):
    ...
    Eq << Eq[-1].this.find(Range).apply(Set.Range.Min.eq.Inter)

    Eq << Eq[-1].this.find(Element).apply(Set.In_Inter.Is.AndInS)

    Eq << Eq[-1].this.lhs.find(Element).apply(Set.In_Range.Is.And)
