...
def prove(Eq):
    ...
    Eq <<= Eq[0].cond.this.apply(Complex.Add.eq.Zero.given.And.Eq.cubic.depressed, x, 1), Eq[0].cond.this.apply(Complex.Add.eq.Zero.given.And.Eq.cubic.depressed, x, -2)
