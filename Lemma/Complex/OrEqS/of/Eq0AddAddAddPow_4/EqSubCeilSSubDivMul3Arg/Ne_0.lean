import Lemma.Complex.Eq0AddAddAddPow_3.of.Eq_Ite_SubAdd_Pow_Inv3.EqSubCeilSSubDivMul3Arg
...
-- proof
  ...
  have hcubic : z ^ 3 + ar * z ^ 2 + br * z + cr = 0 := by
    apply Eq0AddAddAddPow_3.of.Eq_Ite_SubAdd_Pow_Inv3.EqSubCeilSSubDivMul3Arg
    ·
      convert h₁
    ·
      extract_lets
