...
def apply(given, x=None):
    ...
    from Lemma.Algebra.And_Imp_Or_EqS.of.Add.eq.Zero.cubic import cubic_root
...
def prove(Eq):
    ...
    Eq <<= Bool.And.Imp.of.Imp.apply(Eq[-2].this.rhs.apply(Algebra.And_Imp_Or_EqS.of.Add.eq.Zero.cubic), None), Eq[-1].this.rhs.apply(Nat.Div.of.Eq.Ne_0)
