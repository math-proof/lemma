...
def prove(Eq):
    ...
    Eq << Eq[-2].this.lhs.apply(Complex.MulPowS_Inv3.eq.MulPowS.of.EqCeilSubDivAddArgS)
    ...
    Eq <<= Eq[-2].this.lhs.apply(Complex.MulPowS_Inv3.eq.MulPowS.of.EqCeilSubDivAddArgS)
    Eq <<= Eq[-1].this.lhs.apply(Complex.MulPowS_Inv3.eq.MulPowS.of.EqCeilSubDivAddArgS)
