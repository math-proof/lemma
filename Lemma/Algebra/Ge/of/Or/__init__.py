...
def prove(Eq):
    ...
    Eq << Eq[0].this.args[1].args[1].apply(Set.In.NotIn.of.In_SDiff, simplify=None)
    ...
    Eq << Eq[-1].this.find(Or).apply(Algebra.Ge.of.Or.two, wrt=p)

    Eq << Eq[-1].apply(Algebra.Ge.of.Or.two, wrt=p)
