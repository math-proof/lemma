...
import Lemma.Algebra.Permute_SubLength_0.eq.AppendRotateTake___Drop.of.GtLength_0
...
-- proof
  ...
  ·
    have h_i' := Eq.of.EqVal (Eq_Sub.of.EqAdd.nat h_i')
    rw [h_i']
