...
The proof is checked in Lean~4 (updated 2026-09-01) and was first stated interactively in SymPy (2018-11-29).
The quartic statements are
\href{http://www.lemma.cn/lean/?module=Complex.Eq0Add_Mul_Pow_4.is.In_Ite_FinsetSSubS__SubS.of.Ne_0}{Lean~4}~\cite{lemma_quartic_lean}
and
\href{http://www.lemma.cn/py/?module=Complex.In_Ite_FinsetSSubS__SubS.of.Eq0Add_Mul_Pow_4.Ne_0}{SymPy}~\cite{lemma_quartic_sympy};
source is on GitHub~\cite{lemma_repo}.
\end{abstract}
...
This paper records the public Lean~4 lemma
\texttt{Complex.Eq0Add\_Mul\_Pow\_4.is.In\_Ite\_FinsetSSubS\_\_SubS.of.Ne\_0}~\cite{lemma_quartic_lean}:
...
The SymPy counterpart~\cite{lemma_quartic_sympy} is the one-direction lemma
\texttt{Complex.In\_Ite\_FinsetSSubS\_\_SubS.of.Eq0Add\_Mul\_Pow\_4.Ne\_0}
(the Lean \texttt{mp} alias); it has no \texttt{is} if-and-only-if.
Both are visualized on lemma.cn.
Source files are
\texttt{Lemma/Complex/Eq0Add\_Mul\_Pow\_4/is/In\_Ite\_FinsetSSubS\_\_SubS/of/Ne\_0.lean} (branch \texttt{main})
and
\texttt{Lemma/Complex/In\_Ite\_FinsetSSubS\_\_SubS/of/Eq0Add\_Mul\_Pow\_4/Ne\_0.py} (branch \texttt{master})~\cite{lemma_repo}.
  ...
  \begin{itemize}[leftmargin=1.1em,itemsep=0.1em]
    ...
    \begin{itemize}[leftmargin=1.1em,itemsep=0.05em]
      ...
      \begin{itemize}[leftmargin=1.1em,itemsep=0.05em]
        ...
        \item \href{http://www.lemma.cn/lean/?module=Complex.Eq_SquareAddMulSqrt.of.Eq0SubSquare_MulMul4.Ne_0}{\texttt{Eq\_SquareAddMulSqrt.of.Eq0SubSquare\_MulMul4.Ne\_0}} --- Ferrari factor
      \end{itemize}
    \end{itemize}
  \end{itemize}
\end{itemize}
