...
See also the quadratic~\cite{lemma_quadratic_lean} and the cubic~\cite{lemma_cubic_lean}.
The quartic proof calls \texttt{Eq\_Mul\_Pow\_SubCeilS.of.Pow\_3} directly, because Ferrari needs one resolvent root \(A\omega^{k}+B\).
