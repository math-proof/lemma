...
- 生命目标假设3：
  - 即时奖励：有效自由时间，即自由时间的精神效用加权，\({\color{red}{r}} = {\color{red}f} \cdot \mathrm{relu}\left(1-e^{-{\color{red}M}}\right) < {\color{red}f}\)，信念估计值：\({\color{red}{\hat{r}}} = {\color{red}f} \cdot \mathrm{relu}\left(1-e^{-{\color{red}{\hat{M}}}}\right)\)，其负指数函数形式与经济学恒定绝对风险厌恶(CARA)的边际效用递减同构：越富足的人越不把富足当回事
    - 财富是可以自由支配的时间\({\color{red}f}\)：劳动力是人的劳动能力，是存在于人体中并在生产时发挥作用的体力和智力的总和。劳动是劳动力的使用或发挥，是人通过有目的的活动改造自然的过程。商品的价值是凝结在商品中的无差别的人类抽象劳动。劳动本身的量是用劳动的持续时间来计量，而劳动时间又是用一定的时间单位如小时、日等作尺度。故**劳动时间是衡量商品价值的重要尺度**。
...
### 消费主义的陷阱
#### 消费主义的本质
1995年旧金山费尔蒙特饭店召开了一场世界状况论坛，参会的包括：老布什、撒切尔夫人、比尔・盖茨，讨论现实全球化问题：贫富分化，于是布热津斯基发明了成瘾性娱乐产品：奶头乐，目标：
...
- 小猴围着老猴听如何赢得猴王赏识，内容是站队技巧、讨好话术，没一条是觅食技能
...
中国经历长期改革开放，经济水平早已超越最低温饱线，已为个人解放提供必要条件。
因此个人可以通过活学活用马克思主义率先实现个人社会主义。
...
- 问：你会成为对社会无用的无用阶级吗？
- 答：不会。有用的定义是什么？为啥我要做有用的人？人对资本复利有用就是有用的人，这是阶级社会的思想钢印(五阶信念)。用人的工具有用性来衡量人的价值，和市场上比较牛马的交易价值有何区别(六阶信念：怀疑五阶信念)？若有用性估值牺牲跨期效用(远期社会福祉)，就是急功近利。一个人实现全面自由发展是对社会福祉最有效的贡献(六阶信念：修改五阶信念)。

### 实现手段
#### 间歇性奋斗
努力方向远比盲目奋斗更重要。
努力就会成功是资本收割奋斗逼的谎言。
画饼式996福报(五阶信念)是资本设计的精神奖励劫持：自然语言符号精神奖励(生存边界假设1)，如曹操的望梅止渴。
长期全职会挤占成长时间，导致技能停滞，时薪固化。
用人单位的手段是用人，治人，管人，整人，上班的目的是技术变现，不是人的全面自由发展(发展生产力本身)。
...
- 答：按你的逻辑，我不婚不育，人类会灭亡吗？人类灭亡了，我会成为人类的罪魁祸首吗？我不愿被吸血使蚊子灭绝被指责：为何蚊子自己不进化出光合作用？事实上这不是逃票，是另一种购票：
  - 最先逃亡的奴隶，带走了肉身，倒逼了农业革命
  - 最先背井离乡的农民，带走了手艺，撬动了工业革命
  - 最先逃离异化劳动的工人，带走了头脑，发展了复杂劳动，解放了生产力
- 问：你不愿被吸血使蚊子灭绝或进化，不就是**社会达尔文主义**吗？
- 答：是的。按你的逻辑：我乖乖伸脖子被蚊子吸血、主动适配吸血系统，就是反社达？
...
- 兴趣变现是一种自由劳动，其前提：
  ...
  - 非消费(负债)型兴趣(无脑段子)
- 兴趣变现=产消者劳动，主体是生产者，也是消费者，既是谋生手段，又是第一需要
- 兴趣变现≠异化劳动，由《1844年经济学哲学手稿》：在资本主义私有制下，劳动从人的自由自觉的类本质活动，异化为一种被迫的、异己的、与劳动者对立的力量。而兴趣变现是随时可以自由停止的劳动，则兴趣变现≠被迫劳动
- 兴趣变现≠自我剥削，理由
  - 自我剥削：  
