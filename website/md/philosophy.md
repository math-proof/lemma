...
- 问：你会成为对社会无用的无用阶级吗？
- 答：有用的定义是什么？为啥我要做有用的人？人对资本复利有用就是有用的人，是阶级社会的思想钢印。用人的工具有用性来衡量人的价值，和市场上比较牛马的交易价值有何区别？若有用性估值牺牲跨期效用，就是急功近利。社会福祉以\({\color{red}{r}}_t\)量化，非GDP：开源工具(减少他人必要劳动)、文化创作(增益他人精神效用)，是不以盈利为目的的自由劳动，通过共享经济反哺社会福祉。故个人享用公共福利绝非寄生、搭便车，其全面自由发展是对社会福祉最有效的贡献。
- 问：为何不用GDP量化社会福祉？
