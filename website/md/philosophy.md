...
社会上有一套钱生钱的财富自由论。本文将数理Marxism、布迪厄社会学、认知博弈论、健康动力学融入简洁的概率公式、期望方程等**符号暴力美学**中，构建了一套个人社会主义生存算法，以回答：
- 什么是财富？
- 什么是自由？
- 什么是财富自由？
- 谁在生产财富，谁在收割自由？
  ...
  - 社会资本，是指人际、组织、政治等关系价值，在主体遭遇风险时转化为实际支持的能力：
    - 人脉资产\(\color{red}P\)：亲情、爱情、友情、人情、仇人等关系价值，共计\(\mathfrak {D} \le 150\)人
      - 心智理论：事件驱动型共情系数\({\color{red}Ι}_{t,i,j}\in (-1,1)\)是关系网络有向图点对点权重，i表示人称代词(i=0表示我)，未激活为0
        ...
        - 四阶信念：\({\color{red}{Ω}}^{[i,j,k,l]}_t={\color{red}Ι}_{t,i,j} \mathbb E\left[{\color{red}{Ω}}^{[j,k,l]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k]}_t \right]\)，虚构叙事、印象管理，表现为羞辱、诽谤、奉承、赞美、欺骗、杀人诛心；冯·诺伊曼打牌十打九输，Bayes、全概率公式都用上了，却还是输？不懂**隐藏意图**(我不想让[对手获知[我评估[各方的牌]]])，好牌得意忘形，烂牌垂头丧气，一举一动被看得透透的，不输才怪
        ...
        - n阶信念：\({\color{red}{Ω}}^{i_{:n}}_t={\color{red}Ι}_{t,i_0,i_1}\mathbb E\left[{\color{red}{Ω}}^{i_{1:n}}_t\middle|{\color{magenta}{Ω}}^{[i_{:n-1}]}_t \right]\)，我对你n-1阶信念奖励期望乘上你我共情系数
      ...
      - 人脉日折当率：\(δᵣ = \frac{\ln 2}{\beta_p Y_s}\)，无形资产折当依据：心理学：艾宾浩斯遗忘曲线，社会交换理论：互惠义务具有时效性
...
### 清算伪(或次生)资产
Marx：**一切经济最终都归结为时间经济**。以下以兑换成有效自由时间的难度为标尺来分析各类资产的可用性：
- 存款  
...
- 人脉  
  ...
  - 家庭是微型股市
    操盘手信息垄断、舆论洗脑，散户相互猜测，结果少数获利，多数受苦。
    真实案例：父亲(他)自食其力，母亲(她)住院失能，姐弟(你我)分别向他打款。他通过树立慈父人设(操劳她的医疗事宜=他为你(我)分忧减负)，孝道绑架(核查账目=监督权=质疑长辈=不孝)，用猜疑链导致囚徒困境(信息茧房)，实现信息差套利，阻挠公开账目的盟友共识。六阶信念拓扑：
    我识破[
        他赌定[
          我(你)赞同[你(我)赞同[他的慈父人设]]∧
          我(你)害怕[你(我)嫌弃[我(你)怀疑[我(你)的打款≠她的医疗费]]]∧
          我(你)不知道[你(我)的打款∨她的报销款]
        ]∧
        他害怕[我(你)知道[你(我)知道[他的利润=你我打款-她的医疗费+她的报销款]]]
    ]
    我核查账目并公开，原高阶套利信念失效，他交接家政，同意直接医院打款。他持续消耗家庭情谊当票的行为被终止，亲情不再被利益绑架，避免亲情彻底绝当。
    互相消耗零和→各司其职正和，实现Pareto最优：打破信息壁垒、重构资金流程、划清权责边界，回归她的具身效用，压缩不当得利，你我负债↓，福祉总和↑。
  - 真爱的猜疑链
    四阶信念：他(她)认为[她(他)不相信[他(她)想念[另一个她(他)]]]。不兑换自由时间，但提升有效自由时间。《红楼梦》的家族利益：林黛玉认为[宝玉知道[贾母怀疑[王夫人想让[薛姨妈认可[宝玉想娶[宝钗]]]]]]，情执驱动**焚稿断痴情**。贾宝玉看破红楼七阶迷雾，悟道出家、抽身世俗是理性选择。高阶信念奖励是元认知心流，非多巴胺分泌剂量。《人类简史》指出：操控生化系统产生快感，不等于虚构故事驱动的人类福祉。夫妻遇死神，猜拳定生死；共谋出石头，一布一剪刀。用高阶信念和催产素(神经还原论)分别如何解释？
- 汽车  
...
周国平箴言
- 知世故却不世故  
  世故是N阶信念，世事洞明、知不世故就要N+1阶信念。消费主义是四阶信念：商家知道[你要让[他人认为[你活得像个人]]]，解构消费主义是五阶信念：我识破[商家四阶信念]，你本来就是人，为何要让他人认为你活得像个人？
- 历圆滑而弥天真  
  我知道圆滑是高阶信念游戏，拒绝入局是更明智的活法，我只认：健康、头脑是一阶信念，技能、货币是三阶信念(解决生存问题)，Marxism是五阶信念(解释人生意义：我相信[大家公认[Marx推断[我们坚信[人类福祉=人的全面自由发展]]]])。除此之外，一种信念只要超过三阶，都要警惕。这套认知极简的筛选算法叫**天真**。
...
个人唱戏：个人通过活学活用Marxism，自由劳动，产消合一，先行实现个人社会主义。
Marxism是一套摆脱劳动异化、实现人的全面自由发展的解放哲学，没有教我们拼命干活。
...
- 成功学悖论  
  ...
  其宣传的成功是零和博弈：职场编制，头部岗位，学阀名额。培根：愚蠢是别人的福气，故成功是别人的失败。进而养老等死，活到百岁，别人死光，亦能成功。**不努力也成功**！为存量厮杀的成功学是生态位竞争技巧，默认优胜劣汰、弱肉强食，将人类降维至丛林斗兽场：物竞天择、适者生存。若你失败，就不算**活得像个人**，而是条沙丁鱼，应被末位淘汰(鲶鱼效应)。这是文明，还是野蛮？
