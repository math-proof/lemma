...
\)
    ...
    - 当天年龄：\(A_t = \frac t {Y_s}\)
    - \(\color{red}H\)：健康指数(通过体检可观测)，\(H_{tₘᵢₙ} = 100\)
...
\sum_{j=0}^{t_{oo} - t - 1} \mathbb E\left[ \prod_{j=0}^{j}(1-{\color{red}q}_{t+j}) \middle| {\color{red}H}_t \right]\]
    ...
    - \(\color{red}M\)：精神效用指数，部分可观测(哭笑等表情)，真实心情不可测，\(M_{t_{min}} = 100\)
      ...
      - 事件驱动型精神奖励脉冲(下文心智理论)：\({\color{red}{Ξ_m}}_t = {\color{red}{Ω}}^{[0]}_t + \sum_{j=1}^{\mathfrak{N}-1}\left({\color{red}{Ω}}^{[0,j]}_t + \sum_{k=1}^{\mathfrak{N}-1}\left({\color{red}{Ω}}^{[0,j,k]}_t+\sum_{l=1}^{\mathfrak{N}-1}\left({\color{red}{Ω}}^{[0,j,k,l]}_t+\sum_{m=1}^{\mathfrak{N}-1}\left({\color{red}{Ω}}^{[0,j,k,l,m]}_t+\sum_{n=1}^{\mathfrak{N}-1}\left({\color{red}{Ω}}^{[0,j,k,l,m,n]}_t + \sum_{o=1}^{\mathfrak{N}-1}{\color{red}{Ω}}^{[0,j,k,l,m,n,o]}_t\right)\right)\right)\right)\right)\)，人逢喜事精神爽，闷上心来瞌睡多，如：情人变心、仇人被杀、悲欢聚散，还有爱别离、怨憎会、求不得，甚至死亡当天以西方极乐世界为标的的往生居住权(**延迟奖励**)
  ...
  - 社会资本，是指人际、组织、政治等关系价值，在主体遭遇风险(含生存竞争)时转化为实际支持的能力：
    - 人际关系资产\(\color{red}P\)：[亲情、爱情、友情、人情、人脉(含仇人)]关系价值，共计\(\mathfrak {D} \le 150\)人
      - 心智理论，其中事件驱动型共情系数\({\color{red}Ι}_{t,i,j}\in (-1,1)\)是关系网络有向图点对点权重，i表示人称代词(i=0表示我，j>0表示你，k表示他)，未激活为0：
        ...
        - 二阶信念：\({\color{red}{Ω}}^{[i,j]}_t={\color{red}Ι}_{t,i,j}\mathbb E\left[{\color{red}{Ω}}^{[j]}_t\middle|{\color{magenta}{Ω}}^{[i]}_t\right]\)，我对你的互惠同情心(或敌意：Ιₜᵢⱼ<0)，是[4岁孩童智商](https://zhuanlan.zhihu.com/p/461128550))；条件期望的依据：庄子游于濠梁之上，体验了出游从容之乐，故他感同身受地说：鲦鱼出游从容是鱼之乐也；惠子曰：子非鱼，**安**知鱼之乐，是在质疑其估值的条件来源？[按钮思想实验](https://lecturia.org/en/short-stories/richard-matheson-button-button/24784/)：你有个按钮，按一下多活一天，地球上就有个陌生人死去，你会按吗？求解期望不等式：\({\color{red}{Ω}}^{[i]}_t + {\color{red}{Ω}}^{[i,j]}_t={\color{red}{Ω}}^{[i]}_t + {\color{red}Ι}_{min}\mathbb E\left[{\color{red}{Ω}}^{[j]}_t\middle|{\color{magenta}{Ω}}^{[i]}_t\right] = \frac 1 {Y_s} - {\color{red}Ι}_{min}\mathbb E\left[人类剩余寿命\right] = \frac 1 {Y_s} - {\color{red}Ι}_{min}\left(\mathbb E\left[人类寿命\right]-\mathbb E\left[人类年龄\right]\right) \approx \frac 1 {Y_s} - {\color{red}Ι}_{min}\cdot (73.5 - 30.5) > 0\)，当你的共情系数Ιₘᵢₙ<6.37e-5时，大概率会按下按钮
        ...
        - 五阶信念：\({\color{red}{Ω}}^{[i,j,k,l,m]}_t={\color{red}Ι}_{t,i,j} \mathbb E\left[{\color{red}{Ω}}^{[j,k,l,m]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k,l]}_t \right]\)，意识形态：我相信[大家公认[祂希望[我们期待[人死后去天堂]]]]；千古第一阴谋(利用信息差)·金刀计：王猛赌定[金熙接受[慕容令笃信[慕容垂想让[慕容令叛逃]]]∧苻坚猜忌[慕容垂谋反]]，这个信念拓扑的最优调度，比如慕容垂亲信金熙(间谍)被收买后用金刀卖力做局、假传父命、劝说慕容令(受计者)叛逃，就是王猛(施计者)的政治资本增量：慕容垂(被害者)被苻坚(受计者)连坐，而卖力强度∝收买力度∝王猛的\(\color{red}W\)
        ...
        - 七阶信念：\({\color{red}{Ω}}^{[i,j,k,l,m,n,o]}_t={\color{red}Ι}_{t,i,j}\mathbb E\left[{\color{red}{Ω}}^{[j,k,l,m,n,o]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k,l,m,n]}_t \right]\)，《红楼梦》：林黛玉认为[贾宝玉知道[贾母怀疑[王夫人想让[薛姨妈认可[贾宝玉想娶[薛宝钗]]]]]]，最终驱动**焚稿断痴情**
      ...
      - \(\color{red}P\)是状态依赖型期权：
        - 人情社会的看涨：在你生命抵押品(不含\(\color{red}P\))优质时行权(兑现)概率高，在你生命抵押品折损时行权(兑现)概率低。落魄苏秦归故郭(虚值)，妻不下纴，嫂不为炊，父母不与言；当其六国封相(实值)，父母郊迎三十里，妻倾耳而听，嫂蛇行匍伏。何前倨而后恭？
        - 银行信贷的看跌：在你生命抵押品(包括\(\color{red}P\))优质时开仓(放贷)，在你生命抵押品折损时平仓(法拍)。还款能力\({\color{red}\phi}_t\)是条件期望，条件是你的全部身家(包括\(\color{red}P\))，合约白纸黑字写好，比苏秦的嫂子更讲契约精神。掏空6个口袋按揭还贷本质是差序格局金融化：你其实只有一个口袋，其它5个口袋是银行把你的\(\color{red}P\)货币化了
...
**社会就是一辆汽车：经济发动机+哲学制动机**，只有油门、没有刹车的汽车肯定翻车。有人说要功名利禄，有人说要人间清醒，这叫多元化市场经济，哪里有需求，哪里就有消费。到底一个人怎么活才算没白活，依鄙人看，用先验终身福祉(怎么活)、后验终生福祉(有没白活)来计算最合理。
...
## 资产是可兑换财富的筹码
### 认清真资产
健康(一阶信念：我痛故我在)、头脑(一阶信念：我思故我在)、技能(三阶信念：我相信他人认可我的技能的使用价值)，是世间最不易被掠夺的硬通货，除非遭遇人身侵害：谋杀、绑架、监禁。古人云：家有万贯，不如一技在身；手艺是活宝，走遍天下饿不倒。活劳动是价值的唯一来源。资本告诉你：存款、黄金、房产、汽车、金融产品是资产。劳动价值论说，这些身外之物都是次生(或伪)资产，只是贸易的中间媒介，极易被收割。真资产就藏在你自己身上：一条命(身心) + 一门手艺。财富也藏在你自己身上：自由时间。关键是你怎么祛魅人类文明的面纱，用你的真资产来兑换属于你的财富。原因分析：
根据资本论：
...
### 清算伪(或次生)资产
马克思：一切经济最终都归结为时间经济，即时间经济学。故凡是可以兑换成自由时间的资产就是有用资产，否则就是无用资产。以下以自由时间为标尺来分析一些伪(或次生)资产的可用性：
  它是看不见、摸不着的概念(N阶信念博弈：N>邓巴数)。金融市场是**二级混沌系统**，预测行为会改变被预测对象的演化轨迹。凯恩斯选美：N个参与者要从100张照片中选出6张最美的，谁猜中群体平均偏好就获奖。美女的颜值(基本面)不再重要，而是你能否猜中大多数人的猜测。股票**像**啤酒，利好预期吹胀泡沫；待利好落地，卖盘戳破泡沫，形成利好即利空的反逻辑行情。你不理财会生病吗？为啥指望财来理你？巴菲特说：若一项资产的运行逻辑，7岁孩童5分钟无法理解，即伪资产。投机性金融资产的估值、交易、杠杆、风控机制高度抽象，普通个体无法拆解其财富流转逻辑，是收割散户的零和赌局。它不创造劳动性财富，只是财富转移(看得见的收益)工具，反而通过投机、博弈、盯盘吞噬自由时间(看不见的损失)，这就是巴斯夏说的**破窗谬论**。它和商品交易有本质区别：买家获得了使用价值(商品)，卖家获得了交换价值(货币)，双方通过社会分工都节省了自由时间，社会福祉增加，整体正和博弈，这正是西美尔所说的：**过桥**。
- 文凭：
  它是一张纸，不能饱腹御寒，是次生资产。其有用性是你的求职四阶信念：你知道[雇主会核验[教育部是否认可[你的文凭]]]。通过雇主的核验，才能参与劳动力交易。它是制度背书的文化资本，价值依附公权力机构的法定确权。

### 消费主义的陷阱
#### 消费主义的本质
1995年旧金山费尔蒙特饭店召开了一场世界状况论坛，参会的包括：老布什、撒切尔夫人、比尔・盖茨，讨论全球化问题：贫富分化，于是布热津斯基发明了成瘾性娱乐产品：奶头乐
- 修改自由的定义(奖励劫持：假设3)：你以为是在自由地消费，其实是被推荐算法猎杀了，劫持了你的注意力，操控了多巴胺分泌机制，你已不是你，不是你在消费，而是它在消费你的时间
- 修改生存边界的定义(假设1)，通过伪刚需规训，篡改刚需定义，抬高**活得像个人**的底线，最终修改内卷系数(资本贪婪程度)，多赚的剩余价值，你心甘情愿消费掉了，但没花在自己身上

#### 消费主义的识别
高阶信念奖励劫持的心理抓手：
- 米饭：最养人的米饭几块钱一斤，非要去高端饭局，这叫：人情世故还是人情裹挟？
...
周国平箴言
- 知世故却不世故  
  世故是N阶信念，则世事洞明，想到**不世故**就要N+1阶信念。消费主义是四阶信念：形象投资，故怀疑消费主义就是五阶信念。贾宝玉看破红楼的七阶人情迷雾，悟道出家、抽身世俗是理性选择。
- 历圆滑而弥天真
...
个人唱戏：个人通过活学活用马克思主义，兴趣变现，产消合一，先行实现个人社会主义。
...
#### 自由王国
财富自由是必然王国的经济解放，拓宽后验终生福祉积分的时间定义域(F)，即*积分的宽度*。
...
**个人的自由发展是一切人的自由发展的条件**。
当人人都投了个人社会主义的票，国家就能实现宏观社会主义：自由人联合体。在这个精神解放的自由王国，人活着不为成为有用的工具，人活着只为无用的兴趣，晒太阳是为了仰望星空，发呆是为了创造灵感，这种无用之用(精神效用)，就是社会福祉的终极度量。
- 问：你会成为对社会无用的无用阶级吗？
- 答：有用的定义是什么？为啥我要做有用的人？人对资本复利有用就是有用的人，这是阶级社会的思想钢印(五阶信念)。用人的工具有用性来衡量人的价值，和市场上比较牛马的交易价值有何区别(六阶信念：怀疑五阶信念)？若有用性估值牺牲跨期效用(远期社会福祉)，就是急功近利。一个人实现全面自由发展是对社会福祉最有效的贡献(六阶信念：修改五阶信念)。
...
财富自由的核心不是花更多自由时间赚更多钱，而是花更少钱换更多自由时间。
