...
\sum_{j=0}^{t_{oo} - t - 1} \mathbb E\left[ \prod_{j=0}^{j}(1-{\color{red}q}_{t+j}) \middle| {\color{red}H}_t \right]\]
    ...
    - 时间禀赋(24h)：
      - 自由时间\(\color{red}f\)/h：可自由支配的时间，我不想花就可以不花的时间，其否决权是三阶信念：我否认[你认为[我的时间归你]]：
        ...
        - 情感投资\(\color{red}Θ\)：\({\color{red}Θ}_t \in R^{\mathfrak {D}}\)，货币？￥，产生人际关系资产增量ΔPᵣ/h，精神效用增益ΔMᵣ/h
...
\)
    ...
    - 个别剩余价值：\({\color{red}m} = {\color{red}w} - {\color{red}v}\)，依据：活劳动创造的新价值 = 劳动力价值 + 剩余价值。这是超必要劳动盈余，属于《资本论》定义的剩余价值的范畴，是资本家的让渡份额，本文不研究资本家获得的剩余价值
    ...
    - \(\color{red}{tₘₐₓ}\)：有效生命终点，t≤tₘₐₓ≤tₒₒ，直接原因
      ...
      - 破产，由\({\color{red}\phi}_t(\mathbb E[{\color{red}T}|{\color{magenta}H}_t] - t) + \mathbb{E}[{\color{red}{W_p}}_t\mid{\color{magenta}s}_t] + \mathbb{E}[{\color{red}{W_s}}_t\mid{\color{magenta}s}_t] < {\color{red}{W^-}}_t\)触发，被剥夺人身自由，类似刑法逻辑：为何人类文明会选择人身自由作为债务违约的最后抵押品？因为自由是生命的折现，还不了钱，拿自由换
  - 社会资本，是指人际、组织、政治等关系价值，在主体遭遇风险时转化为实际支持的能力：
    - 人际关系资产\(\color{red}P\)：[亲情、爱情、友情、人情、人脉(含仇人)]关系价值，共计\(\mathfrak {D} \le 150\)人
      - 心智理论：事件驱动型共情系数\({\color{red}Ι}_{t,i,j}\in (-1,1)\)是关系网络有向图点对点权重，i表示人称代词(i=0表示我)，未激活为0
        ...
        - 四阶信念：\({\color{red}{Ω}}^{[i,j,k,l]}_t={\color{red}Ι}_{t,i,j} \mathbb E\left[{\color{red}{Ω}}^{[j,k,l]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k]}_t \right]\)，虚构叙事、印象管理，表现为羞辱、诽谤、奉承、赞美、欺骗、杀人诛心；真爱的猜疑链：他(她)认为[她(他)不相信[他(她)想念[另一个她(他)]]]；冯·诺伊曼打牌十打九输，Bayes、全概率公式都用上了，却还是输？不懂**隐藏意图**(我不想让[对手获知[我评估[各方的牌]]])，好牌得意忘形，烂牌垂头丧气，一举一动被看得透透的，不输才怪
        ...
        - 六阶信念：\({\color{red}{Ω}}^{[i,j,k,l,m,n]}_t={\color{red}Ι}_{t,i,j}\mathbb E\left[{\color{red}{Ω}}^{[j,k,l,m,n]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k,l,m]}_t \right]\)，操控群体立场，千古第一阳谋(利用信念差)·推恩令：汉武帝笃定[诸侯王知道[嫡长子知道[庶子相信[汉武帝想让[庶子分封得利]]]]]，施恩造成嫡庶敌对，借此削藩，缔结联盟最快方式是找共同敌人，对应负负得正(敌人之敌)：Ιₜᵢⱼ<0∧Ιₜⱼₖ<0⇒ΙₜᵢⱼΙₜⱼₖ>0
        - 七阶信念：\({\color{red}{Ω}}^{[i,j,k,l,m,n,o]}_t={\color{red}Ι}_{t,i,j}\mathbb E\left[{\color{red}{Ω}}^{[j,k,l,m,n,o]}_t\middle|{\color{magenta}{Ω}}^{[i,j,k,l,m,n]}_t \right]\)，《红楼梦》：林黛玉认为[宝玉知道[贾母怀疑[王夫人想让[薛姨妈认可[宝玉想娶[宝钗]]]]]]，情执驱动**焚稿断痴情**
        - n阶信念：\({\color{red}{Ω}}^{i_{:n}}_t={\color{red}Ι}_{t,i_0,i_1}\mathbb E\left[{\color{red}{Ω}}^{i_{1:n}}_t\middle|{\color{magenta}{Ω}}^{[i_{:n-1}]}_t \right]\)，我对你n-1阶信念奖励期望乘上你我共情系数；递归高阶信念奖励是元认知心流，非多巴胺分泌剂量。《人类简史》指出：操控生化系统产生快感，不等于虚构故事驱动的人类福祉。夫妻遇死神，猜拳定生死；共谋出石头，一布一剪刀。用高阶信念和催产素(神经还原论)分别如何解释？
      - 锦上添花式资助\(\color{red}{W_p}\)/￥：\(\mathbb{E}\left[{\color{red}{W_p}}_t \middle|{\color{magenta}s}_t \right] = \omega_p{\color{red}P}_t \times \sigma\left(\eta_W {\color{red}{W}}_t + \eta_H {\color{red}{H}}_t+ \eta_L {\color{red}{L_p}}_t- \eta_v {\color{red}{v}}_t\right),\qquad \eta_W,\eta_H, \eta_L, \eta_v\in \mathbb R^{\mathfrak {D}}\)，依据《乡土中国》差序格局：人际关系像水波纹，以己为心、亲疏有别、随势伸缩。我帮了某人(当品：情谊)，我在他心(情谊当铺)中的情谊当票不可观测(他心难题)，只能猜测：我落难赎当时那张当票的折当价是多少？情谊典当记名不记账，若绝当，我(当户)就算上**当**？
      - 半衰期/年：\(\beta_p \in R^{\mathfrak {D}}\)，一般亲情>爱情>友情>人情>人脉，依据社会学：强弱关系理论，演化生物学：亲缘选择理论
      - 人际关系日折当率：\(δᵣ = \frac{\ln 2}{\beta_p Y_s}\)，无形资产折当依据：心理学：艾宾浩斯遗忘曲线，社会交换理论：互惠义务具有时效性
...
- 行为策略公设2
  ...
  - 策略：
    ...
    - 策略分类：
      ...
      - 内卷：m′≫1，用自由换个别剩余价值，通过通胀稀释、理财圈套、广告洗脑、房价倒挂，在流通回收机制下属于资本的口袋
- 生命目标公设3
  ...
  - 先验终身福祉(跨期效用)：\(V_\pi({\color{red}{s}}_t)\)，信念估计值：\(V_\hat\pi({\color{red}{\hat{s}}}_t)=\mathbb E_{\substack{{\color{red}{\hat{r}}}_{t:}\\{\color{red}a} \sim \hat\pi}}\left[\sum_{j=t}^{tₘₐₓ} {\color{red}{\hat{r}}}_j\middle| {\color{red}{\hat{s}}}_t\right]\)，《时间分配理论》：先验终身福祉最大化是将时间视为一种稀缺且不可再生的核心资源，并研究如何对其进行优化配置，以实现效用或价值的最大化
...
人们总以为犬儒主义者是一条玩世不恭、愤世嫉俗、哗众取宠、不谙世故、蔑视权贵的狗，一条在脑残家狗前标榜特立独行的智狗，一条不合群的野狗。其实犬儒主义核心是**物物而不物于物**：以心有足乐者，不知口体之奉不若人，这恰好是古典版的《[简单致富](https://zhuanlan.zhihu.com/p/2025943598730846554)》：
- 问：你要是知道怎样巴结权贵，就不用吃糟糠粗粮活着了。
- 答：你要是知道糟糠粗粮就能活着，就不用去巴结权贵了。

**社会是一辆汽车：经济发动机+哲学制动机**，只有油门、没有刹车的汽车肯定翻车。
有人说要功名利禄，有人说要人间清醒，这叫多元化市场经济，哪里有需求，哪里就有消费。
到底一个人怎么活才算没白活，依鄙人看，用先验终身福祉(怎么活)、后验终生福祉(有没白活)来计算最合理。
...
## 资产是可兑换财富的筹码
### 认清真资产
健康(一阶信念：我痛故我在)、头脑(一阶信念：我思故我在)、技能(三阶信念：我相信他人认可我的技能的使用价值)，是最不易被掠夺的资产，除非遭遇人身侵害：谋杀、绑架、监禁。古人云：家有万贯，不如一技在身；手艺是活宝，走遍天下饿不倒。活劳动是价值的唯一来源。资本告诉你：存款、文凭、人脉、汽车、黄金、房产、金融是资产。劳动价值论说，这些身外之物都是次生(或伪)资产，只是贸易的中间媒介。真资产就藏在你自己身上：一条命(身心) + 一门手艺。财富也藏在你自己身上：自由时间。关键是你怎么祛魅人类文明的面纱，用你的真资产来兑换属于你的财富。由资本论：
...
### 清算伪(或次生)资产
马克思：**一切经济最终都归结为时间经济**。以下以兑换成自由时间的难度为标尺来分析各类资产的可用性：
- 存款  
  它是低风险次生资产，其三阶信念：我相信人们认可我手上的货币具有交换价值。《资本论》指出，货币本身不具备自行增殖的能力。貌似利息I⁺可以钱生钱，但\(α⁺ < \mathbb E[{\color{red}{\pi_s}}_t]\)，越存越亏；利息是通胀补偿，非理财收益。**货币拜物教**是资本主义最成功的意识形态洗脑，其五阶信念：我相信[大家公认[财神希望[我们坚信[钱是万能的]]]]：健康、房车、名誉、婚姻、别人的信念，没有买不到的，只有想不到的。它先忽悠你：先苦后甜，熬过去就好。它让你推迟自由并相信：今天的自由可以存进银行，未来连本带息取出来！但财富自由论明确提醒：存款不是财富，是财富的期权。生死在呼吸间，未来的自由时间\({\color{red}f}_t\)​不是存量，是流量，且每滴流量，要冒着一连串∏(1−qⱼ)的枪林弹雨，才能抵达那个可能不存在的未来的你。存款是战略蓄水池，是自由时间的行权能力，在你失业时，用它兑换自由时间为发展劳动生产率提供机会窗口。若金钱不是以交换自由时间为最终目的，就是西美尔所说的货币异化(桥上安家)：金钱是通往最终价值的桥梁，而人无法栖居在桥上。异化劳动是自由时间的跨期置换，赚钱是用现在发呆的权力，换未来发呆的权力！很多人换亏本了：当下把发呆时间全卖光了，最后还被房贷、车贷、消费贷捆着，到老都没换到发呆的资格，等于白卖了一辈子。
- 文凭  
  它是一张纸，不能饱腹御寒，是次生资产，不能直接兑现自由时间。其有用性是你的求职四阶信念：你知道[雇主会核验[教育部是否认可[你的文凭]]]。通过雇主的核验，才能参与劳动力交易。它是制度背书的文化资本，价值依附公权力机构的法定确权。
- 人脉  
  它是状态依赖型期权(三阶信念·次生资产)
  - 人情社会的看涨  
    在你生命抵押品(不含\(\color{red}P\))优质时行权(兑现)概率高，在你生命抵押品折损时行权(兑现)概率低。苏秦落魄归家(虚值)，妻不下纴，嫂不为炊，父母不与言；当其六国封相(实值)，父母郊迎三十里，妻倾耳而听，嫂蛇行匍伏。何前倨而后恭？
  - 银行信贷的看跌  
    在你生命抵押品(包括\(\color{red}P\))优质时开仓(放贷)，在你生命抵押品折损时平仓(法拍)。还款能力\({\color{red}\phi}_t\)是条件期望，条件是你的全部身家(包括\(\color{red}P\))，合约白纸黑字写好，比苏秦的嫂子更讲契约精神。掏空六口袋按揭还贷是差序格局金融化：你只有一个口袋，其它5个口袋是你的\(\color{red}P\)被货币化了
- 汽车  
  落地就贬值，作为身价的象征(三阶信念)，是消费型伪资产。除非你用来代步跑业务(一阶信念)，把它开到报废，可以兑换不少自由时间。你也可以学巴菲特，雨天出门开车，让老天爷帮你洗车，这叫物尽其用。
- 黄金  
  它是幻觉型避险伪资产。巴菲特说：黄金是从非洲挖出来，然后熔了，再挖个洞埋起来，旁边雇人守着。它没有内生增殖能力，一斤黄金放一万年，不会进行**核聚变**，生出一克黄金。你花1000￥买块破石头，幻想以后有个比你更傻的人，花1500￥买走，这是博傻思维(N阶信念：N>邓巴数)：收割傻瓜，不劳而获。没有一位世界首富是靠囤积黄金发家。乱世藏金是悖论：你揣着黄金去买粮食，只有两种可能，要么被杀，要么被抢。反倒是能工巧匠，哪怕身无分文，也能靠手艺换口饭吃。黄金是硬通货(三阶信念)，讲的是暴力机关的硬通货，不是普通人的；国家需要黄金，个人不需要。史实如下：
  - 明末李自成攻打北京，拷掠助饷
  - 1948年国民政府的金圆券事件
  - 1997年亚洲金融危机，韩国的献金运动
- 房产  
  房屋自住是一阶信念行为。拿来炒房，就是比黄金更伪的伪资产：黄金性质稳定，房子却是持续折旧的钢筋水泥躯壳。房价上涨，是土地溢价、人口红利与资本炒作的泡沫。不少二手房价格倒挂，戳破了它刚需保值纸面富贵的谎言。以租养贷是陷阱：住宅租金回报率常年低于房贷利率，还要抵押未来30年劳动价值。住宅土地使用权70年，可电梯、排水、消防等部件的使用寿命最多20年，每隔20年就要业主全额更换。房龄越老，物业维修费越高，成为倒贴钱的负资产。上世纪50-70年代法国战后高层住宅，短短30年因高维护成本沦为贫民窟，多座被爆破炸毁，沦为废墟。
- 金融  
  它是看不见、摸不着的概念(N阶信念：N>邓巴数)。金融市场是**二级混沌系统**，预测行为会改变被预测对象的演化轨迹。凯恩斯选美：N个参与者要从100张照片中选出6张最美的，谁猜中群体平均偏好就获奖。美女的颜值(基本面)不再重要，而是你能否猜中大多数人的猜测。股票**像**啤酒，利好预期吹胀泡沫；待利好落地，卖盘戳破泡沫，形成利好即利空的反逻辑行情。你不理财会生病吗？为何指望财来理你？巴菲特说：一项资产的运行逻辑，7岁孩童5分钟无法理解，即伪资产。投机性金融资产的估值、交易、杠杆、风控机制高度抽象，普通个体无法拆解其财富流转逻辑，是收割散户的零和赌局。它不创造劳动性财富，只是财富转移(看得见的收益)工具，反而通过投机、博弈、盯盘吞噬自由时间(看不见的损失)，这就是巴斯夏说的**破窗谬论**。它和商品交易有本质区别：买家获得了使用价值(商品)，卖家获得了交换价值(货币)，双方通过社会分工都节省了自由时间，社会福祉增加，整体正和博弈，这正是西美尔所说的：**过桥**。

### 消费主义的陷阱
#### 消费主义的本质
1995年旧金山召开了世界状况论坛，参会者：老布什、撒切尔夫人、比尔・盖茨等，讨论全球化问题：贫富分化，后布热津斯基发明了成瘾性娱乐产品：奶头乐
- 修改自由的定义(奖励劫持：公设3)：你以为是在自由地消费，其实是被推荐算法猎杀了，劫持了你的注意力，操控了多巴胺分泌机制，你已不是你，不是你在消费，是它在消费你的时间
- 修改生存边界的定义(公设1)，通过伪刚需规训，篡改刚需定义，抬高**活得像个人**的底线，最终修改内卷系数(资本贪婪程度)，多赚的剩余价值，你心甘情愿消费掉了，但没花在自己身上
...
- 学习：投资自己是回报率最高的投资，就买成功学课程，这叫：认知升级还是认知消费？

周国平箴言
- 知世故却不世故  
  世故是N阶信念，世事洞明、知不世故就要N+1阶信念。消费主义是四阶信念：商家知道[你要让[他人认为[你活得像个人]]]，解构消费主义是五阶信念：我识破[商家四阶信念]，你本来就是人，为何要让他人认为你活得像个人？贾宝玉看破红楼七阶迷雾，悟道出家、抽身世俗是理性选择。
- 历圆滑而弥天真  
  我知道圆滑是高阶信念游戏，拒绝入局是更明智的活法，我只认：健康、头脑是一阶信念，技能、货币是三阶信念(解决生存问题)，马克思主义是五阶信念(解释人生意义：我相信[大家公认[马克思推断[我们坚信[人类福祉=人的全面自由发展]]]])。除此之外，一种信念只要超过三阶，都要警惕。这套认知极简的筛选算法叫**天真**。
...
个人唱戏：个人通过活学活用马克思主义，自由劳动，产消合一，先行实现个人社会主义。
马克思主义没有要求我们拼命干活，而是一套摆脱劳动异化、实现人的全面自由发展的解放哲学。
...
- 问：你会成为对社会无用的无用阶级吗？
- 答：有用的定义是什么？为何我要做有用的人？人对资本复利有用就是有用的人，是阶级社会的思想钢印。用人的工具有用性来衡量人的价值，和市场上比较牛马的交易价值有何区别？若有用性估值牺牲跨期效用，就是急功近利。社会福祉以\({\color{red}{r}}_t\)量化，非GDP：开源工具(减少他人必要劳动)、文化创作(增益他人精神效用)，是不以盈利为目的的自由劳动，通过共享经济(公共池塘资源自治)反哺社会福祉。故个人享用公共资源绝非寄生、搭便车，其全面自由发展是对社会福祉最有效的贡献。
- 问：为何不用GDP量化社会福祉？
...
- 成功学悖论  
  ...
  资本主义相对奴隶制的先进性：以五阶信念替代三阶暴力信念(奴隶主认为[奴隶预判[偷懒被鞭抽]])，鞭子从一阶肉体痛苦换成了三阶精神折磨(我害怕[同事认为[我不努力]])，鞭子变免费，统治成本降低，是从肉体统治到精神统治的文明进化。
  自愿加班被公开表扬(操控群体共识)，是其爱岗敬业的六阶信念阴谋。
  其宣传的成功是零和博弈(存量厮杀)：职场编制，头部岗位，学阀名额。Bacon：愚蠢是别人的福气，故成功是别人的失败。进而养老等死，活到百岁，别人死光，亦能成功。**不努力也成功**！
- 成功重定义  
  知零和却弃零和，历竞争而弥自由。努力方向比盲目奋斗更重要。战略上重定义成功，战术上间歇性奋斗。
  长期全职挤占成长时间，使技能停滞，时薪固化。
  用人单位是用人，治人，管人，整人的单位，上班目的是技术变现，非人的全面自由发展。
  头部企业平均司龄为2~3年，是间歇性奋斗的现实原因。
  劳动经济学研究证实：间歇务工优于高压全职。
...
- 兴趣变现≠异化劳动，由《1844年经济学哲学手稿》：在资本主义私有制下，劳动从人的自由自觉的类本质活动，异化为一种被迫的、异己的、与劳动者对立的力量。兴趣变现是随时可以自由停止的，则兴趣变现≠被迫劳动
- 兴趣变现≠自我剥削，理由
  - 自我剥削：  
  比他人剥削更高效的统治形式，它伴随一种自由的感觉，让人心甘情愿地压榨自身。剥削者(施虐者)同时是被剥削者(受害者)。功绩至上的主体自认为是自由的，其实是无主人强迫却自愿被剥削的绝对奴仆。
  - 兴趣变现：  
  Aristotle：生产目的在生产之外；实践目的在实践之中。兴趣变现是一种类本质实践：变现是辅产品，兴趣才是目的，和自我剥削的目的不一样。
- 兴趣变现产生的劳动价值不是劳动力价值，也非剩余价值


罗曼·罗兰：世上只有一种真正的英雄主义，就是在认清生活真相后依然热爱生活。  
鲁迅：冷眼看世界，热心过生活。  
那么倘若一个人看破消费主义的欲望编排、刚性负债的终身枷锁、金融游戏的收割陷阱、人情社会的差序格局、资本主义的劳动异化、人类文明的虚伪面纱，仍坚守个人社会主义、夺回自由时间、实现人的全面自由发展，算不算一种当代英雄主义？