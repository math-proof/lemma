...
- 生命目标假设3：
  ...
  - Markov历史无关假设：\(r_i \perp (a_{:i},s_{:i})\mid (s_i,a_i)\) ​，当天状态sᵢ已经充分编码，历史对当天的影响已经写入当天的Hᵢ(身体健康)，Mᵢ(精神效用)，Kᵢ(文化资本)，Bᵢ(经济资本)，Pᵢ(人际关系)，Sᵢ(制度支持)；这些都是历史存量，故假设成立
