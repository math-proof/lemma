...
- 金融产品  
  它是看不见、摸不着的概念(N阶信念：N>邓巴数)。金融市场是**二级混沌系统**，预测行为会改变被预测对象的演化轨迹。凯恩斯选美：N个参与者要从100张照片中选出6张最美的，谁猜中群体平均偏好就获奖。美女的颜值(基本面)不再重要，而是你能否猜中大多数人的猜测。股票**像**啤酒，利好预期吹胀泡沫；待利好落地，卖盘戳破泡沫，形成利好即利空的反逻辑行情。你不理财会生病吗？为啥指望财来理你？巴菲特说：一项资产的运行逻辑，7岁孩童5分钟无法理解，即伪资产。投机性金融资产的估值、交易、杠杆、风控机制高度抽象，普通个体无法拆解其财富流转逻辑，是收割散户的零和赌局。它不创造劳动性财富，只是财富转移(看得见的收益)工具，反而通过投机、博弈、盯盘吞噬自由时间(看不见的损失)，这就是巴斯夏说的**破窗谬论**。它和商品交易有本质区别：买家获得了使用价值(商品)，卖家获得了交换价值(货币)，双方通过社会分工都节省了自由时间，社会福祉增加，整体正和博弈，这正是西美尔所说的：**过桥**。
...
- 问：你会成为对社会无用的无用阶级吗？
- 答：有用的定义是什么？为啥我要做有用的人？人对资本复利有用就是有用的人，是阶级社会的思想钢印。用人的工具有用性来衡量人的价值，和市场上比较牛马的交易价值有何区别？若有用性估值牺牲跨期效用，即急功近利。社会福祉以\({\color{red}{r}}_t\)量化，非GDP：开源工具(减少他人必要劳动)、文化创作(增益他人精神效用)，是不以盈利为目的的自由劳动，通过共享经济(公共池塘资源自治)反哺社会福祉。故个人享用公共福利绝非寄生、搭便车，其全面自由发展是对社会福祉最有效的贡献。
- 问：为何不用GDP量化社会福祉？
