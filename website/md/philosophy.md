...
\sum_{t=0}^{i_{oo} - i - 1} \mathbb E\left[ \prod_{j=0}^{t}(1-{\color{red}q}_{i+j}) \middle| {\color{red}H}_i \right]\]
    ...
    - \(\color{red}M\)：精神效用，\(\mathbb E[{\color{red}M}_i] \in [-\infty, \infty]\)，\(\mathbb E [{\color{red}M}_{i_{min}}] = 100\)
      ...
      - \(\color{red}\Xi_m\)：事件驱动型稀疏精神奖励脉冲，经验性解释：人逢喜事精神爽，闷上心来瞌睡多；例如：情人变心、仇人被杀、悲欢聚散，还有爱别离、怨憎会、求不得，甚至死亡当天以西方极乐世界为标的的往生居住权(**延迟奖励**)
        ...
        - 痛苦：\({\Xi_m}_i < 0\)，半衰期长，依据：恢复动力学：创伤固着(反刍思维)；行为经济学前景理论：损失厌恶\({\lambda_m}_i = \frac{M_i + |{\Xi_m}_i|}{M_i - |{\Xi_m}_i|}\) ≈ 2.25，避害优先于趋利([KTO](https://arxiv.org/abs/2402.01306)算法)；《人生的智慧》：人生首要任务不是去追求幸福，而是去规避痛苦
...
\)
    ...
    - iₘₐₓ：有效生命终点，i≤iₘₐₓ<iₒₒ，随机变量，直接原因
      - 触发死亡，由死亡概率\(q_{i_{max}}\)导致
      - 触发破产，\({\color{red}\phi}_i(\mathbb E[{\color{red}T}|{\color{red}H}_i] - i) + E[{\color{red}{C_p}}_i∣{\color{red}s}_i] + E[{\color{red}{C_s}}_i∣{\color{red}s}_i] < {\color{red}{B^-}}_i\)，系统剥夺其人身自由，类似刑法的底层逻辑：为什么人类文明会选择人身自由作为债务违约的最后生命抵押品？因为自由是生命的折现，还不了钱，拿自由换 
...
- 生命目标假设3：
  ...
  - Markov历史无关假设：\(r_i \perp (a_{:i},s_{:i})\mid (s_i,a_i)\) ​，当天状态sᵢ已经充分编码，历史对当天的影响已经写入当天的Bᵢ(经济资本),Hᵢ(身体健康),Mᵢ(精神效用),Pᵢ(人际关系), Sᵢ(制度支持), Kᵢ(文化资本)；这些都是历史存量，故假设成立
...
- 社会资本：  
  ...
  - 人情本位社会是一套利己主义、双标道德的思想武器:
    - 对人：用人情教唆你买单、支付、兜底
    - 对己：顺境讲人情分红，逆境则抽身甩锅
  - 掏空6个口袋按揭房贷的本质：你其实只有一个口袋还房贷，其它5个口袋就是银行把你的社会资本货币化了。
