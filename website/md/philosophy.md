  ...
  - 社会资本，是指人际及制度性支持等关系价值，在主体遭遇风险(重疾、破产)时转化为实际支持的能力。包括：
    - 人际关系资产\(\color{red}P\)：[亲情、爱情、友情、人情、人脉]关系价值，人脉包括仇人，共计\(\mathfrak {N}\)人
      - 心智理论，其中事件驱动性共情系数\({\color{red}Ι}_{t,i,j}\in [-1,1]\)是关系网络有向图点对点权重，i表示人称代词(i=0表示我，j>0表示你，k表示他)：
        ...
        - n阶信念奖励：\({\color{red}{Ω}}^{i_{:n}}_t=\prod_{k=0}^{n-1}{\color{red}Ι}_{t,i_k,i_{k+1}}\mathbb E\left[{\color{red}{Ω}}^{i_{1:n}}_t\middle|{\color{magenta}{Ω}}^{[i_{:n-1}]}_t \right]\)，我对你n-1阶信念奖励的期望估计与网络共情系数连乘之积，通过操控你n-1阶信念实现奖励最大化；递归高阶信念奖励是信念脑补值，不是多巴胺生化奖惩机制能解释的，《人类简史》：操控人的生化系统，不等价于提高人的福祉
