...
Last run: Steps 1–4 (2026-03-24): `lean.js` — **`Lean_def`** + **`Lean_lemma::echo`** ported (PHP ~8616–8787); `node scripts/test-lean-parser.mjs` — corpus OK.
