...
Presets (see php/parser/README.md):
  ...
  leantacticblock — class LeanTacticBlock
  leanwith        — class LeanWith
  leanattribute   — class LeanAttribute
  lean_def        — class Lean_def
  lean_lemma      — class Lean_lemma
  leanlet         — class Lean_let
